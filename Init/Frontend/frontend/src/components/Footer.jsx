...
function Footer() {
  return (
    <>
    <div className='w-full h-screen px-10 bg-zinc-900 flex'>

        
            <div className='left  left w-1/2 h-full  font-medium'>

            <div className='mt-20 tracking-tighter leading-none uppercase text-[7vw]'>
                <h1>
                    eye-<br />
                    opening
                </h1>
            ...
            <div className=' right overflow-hidden
                ...
                <div className='mt-[2.5vw] tracking-tighter uppercase text-[6.5vw]'>
        ...
        <div className=' w-full h-full flex '>
            <div className='ll w-1/2 text-[1.2vw] font-light h-full '>
                <h2 className='my-6 font-medium'>S:</h2>
                ...
                .map((item,index)=>{
                    ...
                    <div>
                    <h3 className='underline leading-8 tracking-tighter capitalize '>
                        {item}
                    </h3>
                    </div>
                    )
                ...
                <h2 className='my-6 font-medium '>L:</h2>
                ...
                .map((item,index)=>{
                    ...
                    <div>
                    <h3 className='underline leading-10 tracking-tighter capitalize '>
                        {item}
                    </h3>
                    </div>
                    )
                ...
                <h2 className='my-6 font-medium '>E:</h2>
                {['hello@ochi.design']
            ...
            <div className='lr w-1/2 px-44 text-nowrap text-[1.2vw] font-light h-full py-40 '>
                <h2 className='my-10 font-medium '>M:</h2>
                {['home','services','our work','about us', 'insights','contact us']
        ...
        <div className=' mb-10 w-full px-10 flex items-center justify-between '>
            <div className='logo'>
